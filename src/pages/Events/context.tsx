...
export const EventsContextProvider: React.FC = ({ children }) => {
  ...
  const [events, setEvents] = useState<Array<Banner>>([
    { bannerId: 1, createdAt: new Date().getTime(), title: "John Black Mix Tour", image: "https://cdn.dribbble.com/users/1065176/screenshots/14149875/media/03781b98f3252cf54fd1a8553e7e03e2.jpg" },
